...
page_header(APP_NAME, f"Live market framework · v{APP_VERSION}")
...
try:
    ...
    with status_columns[1]:
        metric_card("Portfolio", "Next", "Migration planned")
    with status_columns[2]:
        metric_card("Opportunity Scanner", "Queued", "After intelligence engine")
